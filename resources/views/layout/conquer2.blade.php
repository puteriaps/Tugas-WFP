...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		...
		<img src="conquer2/img/menu-toggler.png" alt=""/>
		</a>
		...
		<ul class="nav navbar-nav pull-right">
					...
					<li>
						<ul class="dropdown-menu-list scroller" style="height: 250px;">
							<li>
								...
								<span class="photo">
								<img src="./conquer2/img/avatar2.jpg" alt=""/>
								</span>
								<span class="subject">
								<span class="from">
								Lisa Wong </span>
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo">
								<img src="./conquer2/img/avatar3.jpg" alt=""/>
								</span>
								<span class="subject">
								<span class="from">
								Richard Doe </span>
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo">
								<img src="./conquer2/img/avatar1.jpg" alt=""/>
								</span>
								<span class="subject">
								<span class="from">
								Bob Nilson </span>
			...
			<li class="dropdown user">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
				<img alt="" src="conquer2/img/avatar3_small.jpg"/>
	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li >
					<a href="{{ url('/product/showallproduct') }}">
					<i class="icon-puzzle"></i>
					<span class="title">Show All Medicines With Category Name</span>
					<span class="arrow "></span>
					</a>
				</li>
				<li >
					...
					<i class="icon-puzzle"></i>
					<span class="title">Show All Transaction</span>
					<span class="arrow "></span>
					</a>
				</li>
				<li >
				...
				<li >
					...
					<i class="icon-puzzle"></i>
					<span class="title">List Buyers</span>
					<span class="arrow "></span>
					</a>
				</li>
				<li >
					...
					<i class="icon-puzzle"></i>
					<span class="title">New Buyer</span>
					<span class="arrow "></span>
					</a>
				</li>
				<li >
